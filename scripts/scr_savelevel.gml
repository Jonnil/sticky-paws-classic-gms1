...
if global.star_coin1=true{ini_write_real("Level"+string(global.current_level),"star_coin1",true);}
if global.star_coin2=true{ini_write_real("Level"+string(global.current_level),"star_coin2",true);}
if global.star_coin3=true{ini_write_real("Level"+string(global.current_level),"star_coin3",true);}
if global.star_coin4=true{ini_write_real("Level"+string(global.current_level),"star_coin4",true);}
if global.star_coin5=true{ini_write_real("Level"+string(global.current_level),"star_coin5",true);}
